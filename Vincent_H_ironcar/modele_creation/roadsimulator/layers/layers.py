...
#            
            self.middle_line_type = 'plain'    
            #on veut tracer une ligne du milieu en pointillés
            draw_one_line(draw, middle_line, right_turn=right_turn)
...
class Perspective(Layer):
    ...
    def __init__(self, output_dim=(250, 190), name='Perspective'):
        """
        Arguments:
...
class Crop(Layer):
    ...
    def __init__(self, output_dim=(250, 190), name='Crop'):
        """
        Arguments:
            output_dim: A tuple of 2-integers, (width, height),
...
class Background(Layer):
    ...
    def __init__(self, n_backgrounds, path, n_rot=1, n_res=1, n_crop=1,
                    input_size=(250, 200), output_size=(250, 190),
